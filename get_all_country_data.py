...
with open("countries/"+sys.argv[1]+".csv", "a") as f:
    ...
    for i in range(len(df10)):
        if str(df10.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df11)):
        if str(df11.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df12)):
        if str(df12.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df13)):
        if str(df13.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df14)):
        if str(df14.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df15)):
        if str(df15.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df16)):
        if str(df16.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df17)):
        if str(df17.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df18)):
        if str(df18.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df19)):
        if str(df19.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df21)):
        if str(df21.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df12)):
        if str(df22.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df23)):
        if str(df23.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df25)):
        if str(df25.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df26)):
        if str(df26.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df27)):
        if str(df27.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df28)):
        if str(df28.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df29)):
        if str(df29.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df30)):
        if str(df30.loc[i][5]) == sys.argv[1]:
    ...
    for i in range(len(df31)):
        if str(df31.loc[i][5]) == sys.argv[1]:
